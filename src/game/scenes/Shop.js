...
const SHOP_CARS = [
    ...
    { key: 'modelY',    name: 'EV Y',    unlockKey: 'evspeed_carY',    price: 0,  scale: 0.10, offY: -28, offX: 0, colors: [
        { key: 'evYWhite', swatch: '#ffffff', price: 0, unlockKey: 'evspeed_color_evYWhite' },
        { key: 'modelY',   swatch: '#888888', price: 0, unlockKey: 'evspeed_color_evYGrey' },
        { key: 'evYRed',   swatch: '#dd2222', price: 0, unlockKey: 'evspeed_color_evYRed' },
    ]},
...
export class Shop extends Scene {
    ...
    create() {
        ...
        SHOP_CARS.forEach((car, i) => {
            ...
            const carImg = this.add.image(cx + initOffX, cy + initOffY, activeColorKey)
            ...
            for (const a of activeHitAreas) {
                ...
                if (Math.abs(x - a.cx) <= a.hw && Math.abs(y - ay) <= a.hh) {
                    ...
                    if (a.type === 'select') {
                        ...
                        carImages[a.carKey].setTexture(a.variantKey).setScale(vScale)
