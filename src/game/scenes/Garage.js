...
const CARS = [
    { key: 'playerCar', asset: 'assets/CarFinal.png', name: 'EV 3',    unlockKey: null,              scale: 0.23, offY: -80, offX: 0, colorVariants: ['playerCar','ev3Blue','ev3Red'] },
    { key: 'modelY',    asset: 'assets/modelY.png',   name: 'EV Y',    unlockKey: 'evspeed_carY',    scale: 0.10, offY: -12, offX: 0, colorVariants: ['evYWhite','modelY','evYRed'] },
    { key: 'evS',       asset: 'assets/evS.png',      name: 'EV S',    unlockKey: 'evspeed_evS',     scale: 0.14, offY: -40, offX: 0, colorVariants: ['evS','evsOrange','evsGreen'] },
    { key: 'evX',       asset: 'assets/evX.png',      name: 'EV X',    unlockKey: 'evspeed_evX',     scale: 0.10, offY: -40, offX: 0, colorVariants: ['evX','evxBlue','evxRed'] },
    { key: 'cbt',       asset: 'assets/CBT.png',      name: 'CBT',     unlockKey: 'evspeed_cbt',     scale: 0.12, offY: -40, offX: 0, colorVariants: ['cbtWhite','cbt','cbtPurple'] },
...
export class Garage extends Scene {
    ...
    create() {
        ...
        CARS.forEach((car, i) => {
            ...
            const defaultVariant = car.colorVariants ? car.colorVariants[0] : car.key;
            const textureKey = car.colorVariants && unlocked
                ? (localStorage.getItem(`evspeed_activeColor_${car.key}`) || defaultVariant)
                : car.key;
